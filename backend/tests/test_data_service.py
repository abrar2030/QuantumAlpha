...
class TestDataProcessor(unittest.TestCase):
    ...
    def test_process_market_data_with_features(self):
        ...
        df = self.data_processor.process_market_data(self.market_data, features=['sma', 'rsi'])
    ...
    def test_normalize_data(self):
        ...
        # Check normalization
        self.assertTrue(0 <= df_normalized['close_norm'].min() <= df_normalized['close_norm'].max() <= 1)
        self.assertTrue(0 <= df_normalized['volume_norm'].min() <= df_normalized['volume_norm'].max() <= 1)
