...
class TestBrokerIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.broker_integration = BrokerIntegration(self.config_manager, self.db_manager)
...
class TestExecutionStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.execution_strategy = ExecutionStrategy(self.config_manager, self.db_manager)
