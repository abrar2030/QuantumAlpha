...
class ConfigManager:
    ...
    def _load_from_env(self) -> None:
        ...
        # ML configuration
        self.config['ml'] = {
            'model_registry_path': os.getenv('MODEL_REGISTRY_PATH', '/path/to/model/registry')
        }
...
def get_config_manager(env_file: Optional[str] = None, config_file: Optional[str] = None) -> ConfigManager:
