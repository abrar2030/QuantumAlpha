...
class AuditLogger:
    ...
    def log_event(self, 
                  ...
                  method: Optional[str] = None) -> AuditLog:
        """
...
class RiskCalculator:
    ...
    def calculate_risk_score(self, 
        ...
        try:
            ...
            final_score = min(1.0, base_score * user_multiplier * metadata_multiplier * timing_multiplier)
    ...
    def _get_user_risk_multiplier(self, user_id: Optional[int]) -> float:
        ...
        try:
            ...
            if user.created_at and (datetime.now(timezone.utc) - user.created_at).days < 30:
                multiplier *= 1.3
