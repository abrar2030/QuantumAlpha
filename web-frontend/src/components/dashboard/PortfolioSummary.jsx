...
import { Box, Typography, Grid, Paper, Button, Alert, Skeleton } from '@mui/material';

const PortfolioSummary = ({ portfolioValue, dailyChange, percentChange, isLoading = false, error = null }) => {
  if (isLoading) {
    return (
      <>
