...
const mockRiskMetrics = [
  { metric: 'Value at Risk (95%)', value: '$12,450', change: -2.1, color: '#ef4444' },
  { metric: 'Expected Shortfall', value: '$18,200', change: -1.8, color: '#f59e0b' },
...
const mockStrategyPerformance = [
  { strategy: 'AI Momentum Pro', return: 24.8, volatility: 12.3, sharpe: 1.85, allocation: 35 },
  { strategy: 'Quantum Alpha', return: 31.2, volatility: 18.7, sharpe: 2.14, allocation: 25 },
  { strategy: 'Conservative Growth', return: 12.4, volatility: 6.8, sharpe: 1.32, allocation: 40 }
];

const mockTradeAnalysis = [
  { date: '2024-06-01', symbol: 'AAPL', type: 'buy', quantity: 100, price: 175.23, pnl: 1250, strategy: 'AI Momentum Pro' },
  { date: '2024-06-02', symbol: 'TSLA', type: 'sell', quantity: 50, price: 245.67, pnl: -320, strategy: 'Quantum Alpha' },
  { date: '2024-06-03', symbol: 'NVDA', type: 'buy', quantity: 25, price: 892.45, pnl: 2100, strategy: 'AI Momentum Pro' },
  { date: '2024-06-04', symbol: 'MSFT', type: 'buy', quantity: 75, price: 412.89, pnl: 890, strategy: 'Conservative Growth' },
  { date: '2024-06-05', symbol: 'GOOGL', type: 'sell', quantity: 30, price: 2785.34, pnl: 1560, strategy: 'Quantum Alpha' }
];
          ...
          {mockRiskMetrics.map((metric, index) => (
            <Grid item xs={12} sm={6} md={4} lg={2} key={index}>
              <MetricCard
                ...
                color={metric.color}
                icon={index === 0 ? Shield : index === 1 ? Target : index === 2 ? TrendingUp : Activity}
              />
            </Grid>
          ))}
        </Grid>
        ...
        >
          ...
          <TableContainer>
            <Table>
              <TableHead>
                <TableRow>
                  <TableCell sx={{ color: 'white', fontWeight: 600 }}>Asset Pair</TableCell>
                  <TableCell sx={{ color: 'white', fontWeight: 600 }}>Correlation</TableCell>
                  <TableCell sx={{ color: 'white', fontWeight: 600 }}>Strength</TableCell>
                  <TableCell sx={{ color: 'white', fontWeight: 600 }}>Visual</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
