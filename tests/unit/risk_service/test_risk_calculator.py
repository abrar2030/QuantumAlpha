...
class TestRiskCalculator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_returns = np.array([0.01, -0.02, 0.005, 0.008, -0.01, 0.02, -0.015, 0.012, -0.005, 0.018])
        
        # Create sample equity curve
        self.sample_equity_curve = np.array([100000, 101000, 99000, 99500, 100300, 99200, 101000, 99500, 100500, 102000])
    ...
    def test_calculate_portfolio_risk(self):
        ...
        self.risk_calculator._get_historical_data = MagicMock(return_value=self.sample_returns)
    ...
    def test_calculate_var(self):
        ...
        # Calculate VaR
        var_95 = self.risk_calculator._calculate_var(self.sample_returns, confidence_level=0.95)
        var_99 = self.risk_calculator._calculate_var(self.sample_returns, confidence_level=0.99)
    ...
    def test_calculate_cvar(self):
        ...
        # Calculate CVaR
        cvar_95 = self.risk_calculator._calculate_cvar(self.sample_returns, confidence_level=0.95)
    ...
    def test_calculate_sharpe_ratio(self):
        ...
        sharpe = self.risk_calculator._calculate_sharpe_ratio(self.sample_returns, risk_free_rate=0.0)
        sharpe_custom = self.risk_calculator._calculate_sharpe_ratio(self.sample_returns, risk_free_rate=0.02)
    ...
    def test_calculate_sortino_ratio(self):
        ...
        sortino = self.risk_calculator._calculate_sortino_ratio(self.sample_returns, risk_free_rate=0.0)
        sortino_custom = self.risk_calculator._calculate_sortino_ratio(self.sample_returns, risk_free_rate=0.02)
    ...
    def test_calculate_returns(self):
        ...
        np.testing.assert_almost_equal(returns, np.array([0.02, -0.0098, 0.0198, 0.0194]), decimal=4)
