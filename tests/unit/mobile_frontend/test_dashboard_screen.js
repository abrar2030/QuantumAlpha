...
// Mock components
jest.mock('../../../QuantumAlpha-main/mobile-frontend/src/components/dashboard/MarketOverview', () => 'MarketOverview');
jest.mock('../../../QuantumAlpha-main/mobile-frontend/src/components/dashboard/StrategyCard', () => 'StrategyCard');
jest.mock('../../../QuantumAlpha-main/mobile-frontend/src/components/dashboard/AlertItem', () => 'AlertItem');

// Mock hooks
jest.mock('../../../QuantumAlpha-main/mobile-frontend/src/hooks/useTheme', () => () => ({
  primary: '#1976d2',
  background: '#ffffff',
  card: '#f5f5f5',
  text: '#000000',
...
// Mock services
jest.mock('../../../QuantumAlpha-main/mobile-frontend/src/services/portfolioService', () => ({
...
jest.mock('../../../QuantumAlpha-main/mobile-frontend/src/services/strategyService', () => ({
  getActiveStrategies: jest.fn().mockResolvedValue([
    { id: 'strategy1', name: 'Momentum Strategy', performance: 12.5, risk: 'medium' },
    { id: 'strategy2', name: 'Value Strategy', performance: 8.3, risk: 'low' },
  ]),
}));

jest.mock('../../../QuantumAlpha-main/mobile-frontend/src/services/alertService', () => ({
  getRecentAlerts: jest.fn().mockResolvedValue([
    { id: 'alert1', type: 'price', symbol: 'AAPL', message: 'AAPL reached target price', timestamp: '2023-05-01T10:30:00Z' },
    { id: 'alert2', type: 'strategy', symbol: 'MSFT', message: 'Buy signal for MSFT', timestamp: '2023-05-01T09:15:00Z' },
  ]),
}));
