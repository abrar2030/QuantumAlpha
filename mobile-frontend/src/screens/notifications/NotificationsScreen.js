  ...
  const notifications = [
    {
      ...
      type: 'system',
      title: 'System Update',
      message: 'QuantumAlpha has been updated to version 1.0.0 with new features and improvements.',
    ...
    },
    {
      ...
      message: 'We recommend enabling two-factor authentication for enhanced security.',
